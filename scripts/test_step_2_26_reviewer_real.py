...
""".strip(),
    ...
    print("=" * 72)
    print("STEP 2-26-3 REVIEWER REAL TEST")
    print("=" * 72)
    ...
    assert metadata.get("role") == "reviewer"
    ...
    print(
        ...
        len(result["revision_instructions"]),
    )
    print(
        "model=",
        metadata.get("model"),
    ...
    print()
    print("PASS: Reviewer model routing")
    print("PASS: Review JSON generation")
    print("PASS: REVIEW_ARTIFACT validation")
    print("PASS: Reviewer metadata")
    print()
    print("PASS: STEP 2-26-3")
